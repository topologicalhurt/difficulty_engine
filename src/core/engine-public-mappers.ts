  ...
  return Object.fromEntries(
    Object.entries(difficultyModel.byId).map(([id, entry]) => [
      id,
      {
        ...
        actualsScope: entry.actualsScope,
        bookActualConfidence: entry.bookActualConfidence,
        groupActualConfidence: entry.groupActualConfidence,
        groupActualBookCount: entry.groupActualBookCount,
        groupObservedMinutesPerPage: entry.groupObservedMinutesPerPage,
        groupResidualDirection: entry.groupResidualDirection,
